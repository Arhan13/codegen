        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-1">
              Manage translations across languages
            </p>
          </div>
          <button
                ...
                {entries.map((entry) => (
                  ...
                  >
                    ...
                    {languages.map((lang) => (
                      <td
                        key={lang.code}
                        className="px-6 py-4 text-sm text-gray-900 dark:text-white max-w-xs"
                      >
                        {editingCell?.entryId === entry.id &&
                        editingCell?.field === lang.code ? (
                          <input
                            type="text"
                            value={editValue}
                            onChange={(e) => setEditValue(e.target.value)}
                          ...
                          <div
                            ...
                            onClick={() =>
                              handleEdit(
                                ...
                                lang.code,
                                entry[
                                  lang.code as keyof LocalizationEntry
                                ] as string
                              )
                            }
                          >
